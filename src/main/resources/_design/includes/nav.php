<nav class="navbar navbar-expand-lg bg-blue text-uppercase fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="http://localhost:3000/graphics-redesign/">
            <img src="assets/img/ccsd-main-logo-white.png" alt="Graphics Art Center">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 "
                                                     href="http://localhost:3000/graphics-redesign/"
                                                     title="Home">Home</a></li>
                <!-- <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 " href="#products">Products -->
                <!-- We Offer</a></li> -->
